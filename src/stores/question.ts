...
export const useQuestionStore = defineStore("question", () => {
	...
	const clearQuestion = () => (question.value = questionVal.value = null);
	...
	const isAnswered = (category: string, question: string | number) =>
		answered.value.includes(`${category}|${question}`);
